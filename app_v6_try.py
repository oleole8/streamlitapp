...
@st.cache()
def load_data():
    url1 = "https://drive.google.com/file/d/1ORoh1L6lQRkPOR1UAq52bl9uJWLt45Gl/view?usp=sharing"
    url1 = "https://drive.google.com/uc?export=download&id=" + url1.split('/')[-2]
...
@st.cache()
def load_x_data():
    url2 = "https://drive.google.com/file/d/1Sx_lOk940HGtvZPWP7-TbU9mT27w0Qhl/view?usp=sharing"
    url2 = "https://drive.google.com/uc?export=download&id=" + url2.split('/')[-2]
    x_train_data = pd.read_csv(url2)    
